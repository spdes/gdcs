"""
This is a modification of the ImageGrid class from matplotlib's axes_grid1 module, in particular at the line
https://github.com/matplotlib/matplotlib/blob/a254b687df97cda8c6affa37a1dfcf213f8e6c3a/lib/mpl_toolkits/axes_grid1/axes_grid.py#L381

The modification is made because ImageGrid forces to share both x and y which I do not want at all in this project.
It's hard to request this feature from a higher level, so I have to modify the lib code.
"""
...
from mpl_toolkits.axes_grid1.axes_divider import Size, SubplotDivider, Divider
from mpl_toolkits.axes_grid1.mpl_axes import Axes, SimpleAxisArtist
...
class AxesGrid(Grid):
    ...
    def __init__(self, fig,
        ...
        super().__init__(
            ...
            share_all=share_all, share_x=share_x, share_y=share_y, aspect=aspect,
